...
$ui.text("You can display long text in a separate VSCode window.");
[void]$ui.dialog_buttons("Show me");
$ui.window_show_text($longText);

$ui.log("");
$ui.text("Optionally, you can provide VSCode editors language identifier to highlight the text.");
[void]$ui.dialog_buttons("Show me");
$powershellHellowWord = @"
...
"@
$ui.window_show_text($powershellHellowWord, "powershell");