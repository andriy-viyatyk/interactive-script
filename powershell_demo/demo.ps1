...
$ui.text("This demo shows some features you can do with powershell and Interactive Script VSCode extension.");

$progress = $ui.show_progress("Gathering services information...");
...
$progress.complete("Services information gathered successfully.");


$progress = $ui.show_progress("Gathering processes information...");
...
$progress.complete("Processes information gathered successfully.");

$progress = $ui.show_progress("Gathering network connections and open ports information...");
...
$progress.complete("Network connections and open ports information gathered successfully.");